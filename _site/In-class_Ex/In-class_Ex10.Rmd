...
```{r}
packages = c('tidyverse','lubridate','tidyquant','ggHoriPlot','timetk','ggthemes','plotly')
for (p in packages){
...
`tq_get()` is used to extract stock daily values from Yahoo Finance.
...
## Stock Price Line Graph: ggplot methods
...
## Candlestick Chart and MA Lines: tidyquant method
...
## Bollinger Bands: tidyquant method
...
## Interactive Candlestick Chart: ggplot2 and plotly R method
